...
import { Stethoscope, Percent, Gift } from "lucide-react";
  ...
  return (
    <section className="text-center mb-8 xs:mb-10 sm:mb-12 lg:mb-16">
      ...
      <p className="text-base xs:text-lg sm:text-xl lg:text-2xl text-gray-600 mb-6 xs:mb-7 sm:mb-8 max-w-4xl mx-auto px-4">
        Experience the gift of clear vision this Black Friday. At Sight Givers,
        we believe in our mission to
        <span className="text-blue-600 font-semibold">
          {" "}
          "Give Sight, Save Lives"
        </span>
        . Don't miss this incredible opportunity to prioritize your eye health.
      </p>
